...
class FakerMethodCollection
{
    /**
     *
     * @var array of FakerMethod
     */
    protected static $allfakerMethods;
    
    protected static function initialize() 
    {
        if (empty(self::$allfakerMethods)) {
            ...
            self::$allfakerMethods = array();
            foreach($methods as $method) {
                self::$allfakerMethods[$method['method']] = new FakerMethod($method['provider'], $method['method'], $method['culture'], $method['arguments'], $method['examples']);
            }
        } 
    }
    ...
    public static function getAvailableFakerMethods()
    {
        static::initialize();
        $result = array();
        foreach (self::$allfakerMethods as $fakerMethod) {
